export default function CreateForm(props) {
    return (
        <form onSubmit={props.onSubmit} className='w-5/6 p-4 space-y-5 font-semibold text-center border-2 rounded-md border-emerald-400 bg-emerald-200'>
            <div className='text-center'>
                <label className='flex w-full'> Location
                    <input name='location' type='text' className='w-full ml-2'></input>
                </label>
            </div>
